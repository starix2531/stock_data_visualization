                ...
                <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute top-2 inset-y-0 right-0 px-3 flex items-center text-sm font-medium text-gray-600 hover:text-indigo-600 focus:outline-none"
                      >
                        {showPassword ? (
                    ...
                    {isSigningIn ? 'Signing In...' : 'Sign In'}
                        ...
                        <p className="text-center text-sm">Don't have an account? <button onClick={onRegister} className="hover:underline font-bold">Sign up</button></p>
